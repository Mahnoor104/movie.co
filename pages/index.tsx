    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid}>
          <a href="https://movielinkco.blogspot.com/" className={styles.card}>
            <h2>Documentation &rarr;</h2>
            <p>Here you can find amazing new movies free download HD .</p>
          </a>
          ...
          <a
            href="https://movielinkco.blogspot.com/"
